...
const ContadoresRescate = ({
  enProceso = 0,
  completados = 0,
  total = 0,
  onNuevo = () => {},
  colorNuevo = "#1976d2",       // Puedes cambiar el color desde props o aquí mismo
    ...
    <div className="flex flex-wrap justify-between items-center gap-6 mb-6">
      ...
      <div className="flex flex-wrap justify-center gap-6 flex-grow min-w-[250px]">
        ...
        <div
          ...
          onMouseEnter={(e) =>
            (e.currentTarget.style.background =
              "linear-gradient(135deg, #6b5800, #f9a825)")
          }
          onMouseLeave={(e) =>
            (e.currentTarget.style.background =
              "linear-gradient(135deg, #f9a825, #6b5800)")
          }
        >
          <FaHourglassHalf size={24} /> En Proceso
        ...
        <div
          ...
          onMouseLeave={(e) =>
            (e.currentTarget.style.background =
              "linear-gradient(135deg, #2e7d32, #145214)")
          }
        >
          <FaCheckCircle size={24} /> Completados
        ...
        <div
          style={{
            ...contenedorEstilo,
            background: "linear-gradient(135deg, #1565c0, #0d324d)",
            color: "white",
            boxShadow: "0 3px 8px rgba(21,101,192,0.6)",
          }}
          onMouseEnter={(e) =>
            (e.currentTarget.style.background =
      ...
      <button
        ...
        style={{
          ...
          whiteSpace: "nowrap",
          marginTop: "8px",
          flexShrink: 0, // que no se reduzca si el contenedor se estrecha
        }}
...
export default ContadoresRescate;
