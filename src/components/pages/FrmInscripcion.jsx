...
import Rescate from "../hijos/RescateEvaluacion";
import BuscadorBase from "../Shared/BuscadorBase";

import { ListChecks, FileCheck2, CalendarDays, ArrowLeftCircle } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      >
          ...
          <>
            ...
            <div className="flex flex-wrap gap-3 justify-center mb-5">
              ...
              {vista !== "inscripcionesmaterias" && (
                ...
                >
                  <ListChecks size={25} /> Inscripciones Materias
                </button>
              )}
              {vista !== "periodo" && (
                <button
              ...
              {vista !== "rescate" && (
                <button
                  onClick={() => setVista("rescate")}
                  className={botonClase("bg-yellow-600")}
                >
                  <FileCheck2 size={25} /> Rescate
                </button>
              )}
            </div>
          </>
        ...
        {vista === "rescate" && <Rescate busqueda={busqueda} />}
      </div>
    </div>
  );
};
